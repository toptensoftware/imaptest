...
class Account
{
    ...
    async #buildConversations()
    {
        ...
        */
        ...
        info && info(` - ${elapsed()} updates prepared, bulk writing..`);
    ...
    */
    ...
    dropEverything()
    {
        this.db.transactionSync(() => {
            ...
            let r = this.db.delete("mailboxes");
            this.info && this.info(` - deleted ${r.changes} mailboxes`);
            
            // Delete all messages
            r = this.db.delete("message_references");
            r = this.db.delete("messages");
            this.info && this.info(` - deleted ${r.changes} messages`);
