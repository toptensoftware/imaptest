...
class MailboxConversations
{
    ...
    async _open()
    {
        ...
        let mcoll = Database.db.collection(this.account.collection("messages"));
    ...
    close()
    {
        ...
        this.openCount--;
        if (this.openCount == 0)
            this.account.removeMailboxConversations(this);
    }
...
module.exports = MailboxConversations;