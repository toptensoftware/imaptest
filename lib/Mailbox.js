...
class Mailbox
{
    ...
    async sync(tx)
    {
        await Database.transaction(async (tx) => {
            ...
            // Log it
            this._account.info && this._account.info(` - syncing ${this.name} ${sync_info.box.messages.total} messages...`)
            ...
            {
                this._account.info && this._account.info(` - inserted: ${sync_info.insert_ops.length}`);
            ...
            {
                this._account.info && this._account.info(` - deleted: ${sync_info.delete_ops.length}`);
                let ops = [];
            ...
            {
                this._account.info && this._account.info(` - flagged: ${sync_info.flag_ops.length}`);
